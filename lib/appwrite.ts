...
// NOTE: Does the same thing as above but with increased privileges. Gaining access to an appwrite project via using the appwrite client and an extra key called "NEXT_APPWRITE_SECRET".
